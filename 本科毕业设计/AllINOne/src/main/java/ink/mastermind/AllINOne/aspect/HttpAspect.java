package ink.mastermind.AllINOne.aspect;
...
public class HttpAspect {
	 ...
	 */
	@Pointcut("execution(public * ink.mastermind.AllINOne.controller.*.*(..))")
	public void webLog() {
	}
	...
	public void doAfterReturning(Object ret) throws Throwable {
		...
		if (ret != null)
			System.out
					.println("方法的返回值 : " + ((ret.toString().length() > 100) ? ret.toString().substring(0, 100) : ret));
	}
